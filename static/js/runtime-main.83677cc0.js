!(function (e) {
	...
	(a.e = function (e) {
		...
		if (0 !== t)
			if (t) r.push(t[2]);
				...
				(i.charset = 'utf-8'),
					...
					(i.src = (function (e) {
						return a.p + 'static/js/' + ({}[e] || e) + '.' + { 3: 'e6b46225' }[e] + '.chunk.js';
					})(e));
				var c = new Error();
				u = function (r) {
		...
		(a.p = '/discord-overlay-among_us/'),
		(a.oe = function (e) {
			throw (console.error(e), e);
		});
	var i = (this['webpackJsonpdiscord-overlay-among_us'] = this['webpackJsonpdiscord-overlay-among_us'] || []),
		c = i.push.bind(i);
	(i.push = r), (i = i.slice());
...
//# sourceMappingURL=runtime-main.83677cc0.js.map
